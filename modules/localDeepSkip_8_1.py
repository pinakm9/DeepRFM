...
class LocalDeepSkip_8_1(nn.Module):
...
class DeepRF(rfm.DeepRF):
    def __init__(self, D_r, B, L0, L1, Uo, beta, name='nn', save_folder='.', normalize=False):
        ...
        self.net = LocalDeepSkip_8_1(self.sampler.dim, D_r, B)
